...
//   const profileSummary =`With over seven years of hands-on experience, I specialize in the full data lifecycle—from architecting robust ETL pipelines to deploying predictive models. My background spans:
// Cyber Data Analytics: Developing rule-based and statistical models for financial fraud mitigation.
// Data Engineering: Designing scalable data warehouses and real-time processing systems with Apache Kafka and Spark.
// Business Intelligence: Crafting interactive dashboards that translate complex datasets into clear strategic roadmaps.`
//   return (
...
//               <User className="mr-5 size-10" /> Data Professional 
//             </h2>
